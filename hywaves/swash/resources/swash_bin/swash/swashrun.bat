...
rem    swashrun.bat
rem
rem    Run the SWASH program by means of the SWASH input file
rem    Note: it is assumed that the extension of the input file is '.sws'
rem
rem    Usage: swashrun inputfile [nprocs]
rem
...
if not "%1"=="" goto OK1
  echo.
  echo Usage: swashrun inputfile [nprocs]
  goto END
:OK1
...
if exist %inputfile%.sws goto OK2
  echo.
  echo Error: file %inputfile%.sws does not exist
  goto END
:OK2
