...
!DOS          DIRCH2 = CHAR(92)                                               40.03
        ...
        IF (INIVEF.GT.4) READ (11, *,   ERR=930, END=930) KPART            1.10
        IF (INIVEF.GT.3) THEN
           IF (PARLL) THEN
              DO JJ = 1, NPROC
...
!       SWASH use time coding option 7 (hh:mm:ss.msc)
        ITMOPT = 7
!
      ENDIF
      OUTFO = OUTFIL                                                      40.30
...
!
     ...
     &                ERR=950)
           ...
           WRITE (12, 210) KPART,  'grid partitioning option'              1.10
           IF (PARLL) THEN
              DO II = 1, NPROC
...
!
  ...
  40    CONTINUE
      ...
      ELSE IF (IOPT.EQ.7) THEN
        ...
        DTTIME(2) = 0
        DTTIME(3) = 0
        READ (TIMSTR, '(3I2,1X,I3)', ERR=98) (DTTIME(II), II=4,7)
      ELSE
...
!
  ...
  62    FORMAT (5I2)
        LTS = 10
      ELSE IF (IOPT.EQ.7) THEN
        IF (DTTIME(7).GE.1000) DTTIME(7) = 999
        WRITE (TIMSTR, 72) (DTTIME(II), II=4,7)
  72    FORMAT (3I2,'.',I3)
        LTS = 10
      ELSE
